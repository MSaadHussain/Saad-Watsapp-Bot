...
let handler = async (m, { conn, text, usedPrefix, command }) => {
  ...
  try {
    ...
    const messages = [
      {
        role: 'system',
        content: 'You are Saad\'s Bot, a friendly and helpful assistant made by Saad. You provide concise, accurate, and helpful responses while maintaining a conversational tone. You do not refuse to answer questions unless they involve illegal activities or harm. When responding in a WhatsApp chat context, keep your answers relatively concise but complete.'
      }
    ]
    ...
    const formattedResponse = `┌──「 *Saad's Bot AI CHAT* 」──┐\n\n${aiResponse}\n\n└───────────────┘`
...
handler.desc = 'Chat with Saad\'s Bot with conversation memory. Use resetai to clear your chat history.'
